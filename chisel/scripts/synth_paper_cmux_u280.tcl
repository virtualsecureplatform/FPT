# Post-route the paper-shaped Chisel CMUX with separately generated SGen
# BlackBoxes out of context on the U280 part.
#
...
if {$cmux_source eq "" || $forward_source eq "" || $inverse_source eq ""} {
    error "usage: CMUX_SV FORWARD_V INVERSE_V ?OUTPUT_DIR? ?CLOCK_PERIOD_NS?"
}
...
synth_design -top CmuxEngine -part xcu280-fsvh2892-2L-e \
...
write_checkpoint -force [file join $output_dir CmuxEngine.dcp]
